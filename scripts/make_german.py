...
DE |= {
    ...
    "Add a light": "Lampe hinzufügen",
    "Back": "Zurück",
    "Capture the room as it is now": "Raum so übernehmen, wie er gerade ist",
    "Change a scene": "Szene ändern",
    "Give the scene a name.": "Der Szene einen Namen geben.",
    "If a light cannot show the colour": "Wenn eine Lampe die Farbe nicht darstellen kann",
    "Ignore presence while this scene is showing": "Anwesenheit ignorieren, solange diese Szene aktiv ist",
    "Lights in this scene": "Lampen in dieser Szene",
    "Lights this scene says nothing about": "Lampen, zu denen diese Szene nichts sagt",
    "Move to position": "An Position verschieben",
    "None of this room's lights are available to capture.": "Keine Lampe dieses Raums ist verfügbar, um übernommen zu werden.",
    "Remove a light": "Lampe entfernen",
    "Reorder": "Reihenfolge ändern",
    "Save this scene": "Diese Szene speichern",
    "Scenes in this room, in the order a switch cycles them:\n\n{scenes}": "Szenen in diesem Raum, in der Reihenfolge, in der ein Schalter sie durchschaltet:\n\n{scenes}",
    "Scenes in this room:\n\n{scenes}": "Szenen in diesem Raum:\n\n{scenes}",
    "Set the room up with the normal light controls, then name it here.\n\n{lights}": "Den Raum mit den normalen Lichtsteuerungen einrichten und ihm hier einen Namen geben.\n\n{lights}",
    "{lights}": "{lights}",
    "That scene belongs to a different room.": "Diese Szene gehört zu einem anderen Raum.",
    "This room": "Dieser Raum",
    "Lower half (two-button switches)": "Untere Hälfte (Schalter mit zwei Tasten)",
    "For a rocker that publishes its own words for the bottom button. Leave the state lists empty if the switch has only one button.": "Für Wippschalter, die für die untere Taste eigene Begriffe senden. Die Listen leer lassen, wenn der Schalter nur eine Taste hat.",
    "Press": "Druck",
    "Hold": "Halten",
    "Words for a press": "Begriffe für einen Druck",
    "Words for a double press": "Begriffe für einen Doppeldruck",
    "Words for a hold": "Begriffe für ein Halten",
    ...
    "Add a preset": "Vorlage hinzufügen",
    "Change a preset": "Vorlage ändern",
    "Colour preset": "Farbvorlage",
    "Colour presets": "Farbvorlagen",
    "Colour presets:\n\n{presets}": "Farbvorlagen:\n\n{presets}",
    "Colours named once and picked by name wherever a colour is needed:\n\n{presets}": "Farben, die einmal benannt und überall per Name ausgewählt werden:\n\n{presets}",
    "Kind of colour": "Art der Farbe",
    "Preset": "Vorlage",
    "Remove a preset": "Vorlage entfernen",
    "The colour for {name}.": "Die Farbe für {name}.",
    "Which preset {light} should use.": "Welche Vorlage {light} verwenden soll.",
    "Add a switch": "Schalter hinzufügen",
    "Change a switch": "Schalter ändern",
    "Each press moves one place down this list, then wraps:\n\n{order}": "Jeder Druck geht einen Schritt weiter in dieser Liste und beginnt danach von vorn:\n\n{order}",
    "Light switches": "Lichtschalter",
    "Remove a switch": "Schalter entfernen",
    "Save this switch": "Diesen Schalter speichern",
    "Switches on this room's walls:\n\n{switches}": "Schalter an den Wänden dieses Raums:\n\n{switches}",
    "What this switch cycles": "Was dieser Schalter durchschaltet",
    "": "",
    "Add a room": "Raum hinzufügen",
    "Name the room and pick its lights. Everything else is on the next screen.": "Dem Raum einen Namen geben und seine Lampen auswählen. Alles Weitere folgt auf dem nächsten Bildschirm.",
    ...
    "🌅 Adaptive lighting": "🌅 Adaptives Licht",
    "🌙 Night mode": "🌙 Nachtmodus",
    "🎚️ Light switches": "🎚️ Lichtschalter",
    "🎨 Scenes": "🎨 Szenen",
    "💡 Lights": "💡 Lampen",
    "📋 Summary": "📋 Übersicht",
    "📐 Light calibration": "📐 Lampenabgleich",
    ...
    "🧩 Group behaviour": "🧩 Gruppenverhalten",
    "🪟 Open windows": "🪟 Offene Fenster",
    "Adaptive defaults": "Adaptive Standardwerte",
    "Add a mode": "Modus hinzufügen",
    "Name & states": "Name und Zustände",
    "Rules:\n\n{rules}": "Regeln:\n\n{rules}",
    "Snapshots & ending": "Zwischenstand und Beenden",
    "⚙️ Advanced": "⚙️ Erweitert",
    "⚙️ Snapshots & ending": "⚙️ Zwischenstand und Beenden",
    "✏️ Change a rule": "✏️ Regel ändern",
    "🆕 Add a rule": "🆕 Regel hinzufügen",
    "🌅 Adaptive defaults": "🌅 Adaptive Standardwerte",
    "🎨 Colour presets": "🎨 Farbvorlagen",
    "🎬 Name & states": "🎬 Name und Zustände",
    "📜 Rules": "📜 Regeln",
    "🗑️ Remove a rule": "🗑️ Regel entfernen",
    "Catch calls aimed straight at one of this room's lights, so a dashboard or automation that bypasses the room is still noticed as a manual change rather than being overwritten at the next update.": "Aufrufe abfangen, die direkt an eine Lampe dieses Raums gehen. So wird eine Änderung über ein Dashboard oder eine Automatisierung, die den Raum umgeht, als manuelle Änderung erkannt und nicht bei der nächsten Aktualisierung überschrieben.",
    "Go amber": "Auf Bernstein wechseln",
    "Go warm": "Auf Warmweiß wechseln",
    "Hides the individual lights from dashboards and search, so the room is controlled as one thing. They keep working; they are only out of the way.": "Blendet die einzelnen Lampen in Dashboards und der Suche aus, damit der Raum als Ganzes bedient wird. Sie funktionieren weiterhin, sind nur nicht mehr im Weg.",
    "If one of the lights above is itself a group, control its members individually rather than the group as a whole. Needed for per-light scenes and calibration to reach them.": "Wenn eine der Lampen oben selbst eine Gruppe ist, deren Mitglieder einzeln steuern statt der Gruppe als Ganzes. Nötig, damit Szenen und Abgleich pro Lampe sie erreichen.",
    "Moths navigate by light and are drawn to short wavelengths, so warm or amber attracts far less than the usual evening white.": "Motten orientieren sich am Licht und werden von kurzen Wellenlängen angezogen. Warmweiß oder Bernstein zieht deutlich weniger an als das übliche Abendweiß.",
    "Used when the room goes amber.": "Wird verwendet, wenn der Raum auf Bernstein wechselt.",
